CreateThread(function()
    while true do
        ...
        if #(playerPos - vector3(cfg.sz.x, cfg.sz.y, cfg.sz.z)) < 20.0 then
            sleep = false
...
function Holograms()
    while true do
        ...
        local sleep = true
        -- Hologram No. 1
        if GetDistanceBetweenCoords(-423.41, 1130.95, 325.85, GetEntityCoords(PlayerPedId())) < 10.0 then -- Make sure all these coords are the same and make sure you DONT add a comma...
            sleep = false
